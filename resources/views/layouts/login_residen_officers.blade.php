...
<div class="portal-card">
    ...
    <!-- ADMIN LINK -->
    <a href="login_admin.html" class="admin-link">
        🔐 Admin Access Portal
    </a>
</div>
...
<script>
    ...
    function handleLogin() {
        ...
        if (!email.includes('@gmail.com')) { showMsg('Please use a Gmail address.', 'error'); return; }
        showMsg(`Signing in as ${currentRole === 'officer' ? 'Officer' : 'Resident'}…`, 'success');
        setTimeout(()=>{ showMsg('✅ Login successful! Redirecting…', 'success'); }, 1000);
    }
